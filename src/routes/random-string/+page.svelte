<script lang="ts">
import { AtSign, Check, Copy, History, RefreshCw, Shuffle, Sparkles, Trash2 } from "lucide-svelte";
...
<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
  <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    <div class="flex items-center gap-4">
      ...
      <div>
        <h1 class="text-2xl font-bold tracking-tight text-neutral-900">Random String Generator</h1>
        <p class="text-sm font-medium text-neutral-500">
          Generate browser-side random strings with email-prefix-friendly defaults.
        </p>
      </div>
    </div>
  </div>
